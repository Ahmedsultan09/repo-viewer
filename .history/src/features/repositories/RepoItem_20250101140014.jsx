...
function RepoItem({ repoData }) {
  return (
    <article className="w-1/4 h-44 border rounded-xl flex bg-white justify-between flex-col p-3 hover:filter hover:invert transition-all duration-300 cursor-pointer">
