...
function RepoItem({ repoData }) {
  return (
    <article className="w-1/4 h-72 border rounded-xl flex justify-between flex-col p-3">
      ...
      <p className="text-gray-600 text-xs flex justify-center">
        <strong>Language used:</strong> {repoData.language}
      </p>
      <div className="w-full flex flex-row items-center justify-between gap-6">
        ...
        <button className="w-1/2 h-5 rounded bg-sky-700 text-xs text-white font-bold uppercase">
          Discover
        </button>
      </div>
    </article>
