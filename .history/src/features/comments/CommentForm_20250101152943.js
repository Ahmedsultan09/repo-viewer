    ...
    <form className="w-full flex justify-center flex-col">
      ...
      <div className="w-full flex justify-end gap-4 items-center">
        ...
        <button
          ...
          className="w-24 h-7 text-x p-2 my-1 rounded-xl text-white bg-green-800 uppercase font-bold"
        >
          Add
        </button>
        <button className="w-24 h-7 text-x p-2 my-1 rounded-xl text-white">
          Reset
        </button>
      </div>
    </form>
