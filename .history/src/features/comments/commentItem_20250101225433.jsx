...
function CommentItem({ comment, deleteComment }) {
  ...
  return (
    <li className="w-full flex flex-col items-start justify-center bg-gray-200 p-2 rounded-lg my-2 hover:scale-105 transition-all duration-300">
      ...
      <p className="w-full font-sans p-5 border border-gray-400 rounded-xl text-sm">
        {comment.body}
      </p>
    </li>
  );
